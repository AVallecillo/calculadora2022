...
public class Calculadora implements ICalculadora{
	...
	public int fact(int n) {
		int i=1, j=1;
		if ( n <0) {
			throw new ArithmeticException ("el factorial no se puede calcular"); 

		}
		if (n>=14) {
			throw new IllegalArgumentException ("el factorial no se puede calcular con un int: overflow"); 
